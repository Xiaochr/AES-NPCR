...
def main():
    ...
    modelname = "rank_core_bert_prompt%s" % args.prompt_id
    ...
    evl = Evaluator_opti(args.prompt_id, checkpoint_dir, modelname, features_dev, dev_y_example, dev_y_goal, features_test, test_y_example, test_y_goal, example_size)
    ...
    for ii in range(num_epochs):
        logger.info('Epoch %s/%s' % (str(ii), num_epochs))
